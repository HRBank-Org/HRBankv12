  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-16">
        {/* Video Background - HR Bank official video */}
        <div className="absolute inset-0 z-0">
          ...
          <iframe
            ...
            src="https://www.youtube.com/embed/9hdZhBGO6aw?autoplay=1&mute=1&loop=1&playlist=9hdZhBGO6aw&controls=0&showinfo=0&rel=0&modestbranding=1&playsinline=1"
