...
const WorkforceLanding = () => {
  ...
  const steps = [
    ...
    { num: '3', title: 'Apply to Jobs', desc: 'Browse opportunities and apply with your verified WorkPassport™.' },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                Build a WorkPassport™ that proves your skills, experience, and reliability. 
