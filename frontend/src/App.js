...
import InstitutionPartnershipAgreement from './pages/institution/PartnershipAgreement';
  ...
  return (
    <ThemeProvider userType={user?.user_type || 'workforce'}>
      ...
      <Routes>
        ...
        <Route path="/workforce/routes" element={<ProtectedRoute allowedUserTypes={['workforce']}><WorkerRoutes /></ProtectedRoute>} />
        ...
        <Route path="/employer/payroll-export" element={<ProtectedRoute allowedUserTypes={['employer']}><PayrollExport /></ProtectedRoute>} />
        <Route path="/employer/payroll-sync" element={<ProtectedRoute allowedUserTypes={['employer']}><PayrollSync /></ProtectedRoute>} />
        <Route path="/employer/remote-work" element={<ProtectedRoute allowedUserTypes={['employer']}><RemoteWork /></ProtectedRoute>} />
        ...
        <Route path="/institution/partnership-agreement" element={<ProtectedRoute allowedUserTypes={['institution']}><InstitutionPartnershipAgreement /></ProtectedRoute>} />
