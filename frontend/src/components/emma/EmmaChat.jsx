          ...
          messages.map((message, index) => (
            ...
            >
              ...
              >
                ...
                {message.linkedinAction && message.linkedinAction.type === 'connect' && (
                  <a
                    href={message.linkedinAction.url}
                    className="mt-2 flex items-center justify-center gap-2 px-4 py-2 bg-[#0A66C2] text-white rounded-lg hover:bg-[#004182] transition-colors text-sm font-medium"
                  >
