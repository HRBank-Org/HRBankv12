...
async def linkedin_authorize(
    ...
    # LinkedIn OAuth scopes - OpenID Connect (Sign In with LinkedIn)
...
async def linkedin_callback(
    ...
    full_name = f"{first_name} {last_name}".strip() or linkedin_profile.get("name", "")
    ...
    frontend_url = os.environ.get("FRONTEND_URL", "https://field-service-plus.preview.emergentagent.com")
