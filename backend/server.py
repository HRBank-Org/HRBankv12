...
app.include_router(occupation_templates.router, prefix="/api", tags=["occupation_templates"])
app.include_router(worker_qualifications.router, prefix="/api", tags=["worker_qualifications"])
